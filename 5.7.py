...
#   фирма получила убытки, в расчёт средней прибыли её не включать.
#
...
prof_aver = 0
i = 0
with open('doc_5_7.txt', 'r') as file:
    for line in file:
    ...
    if i != 0:
        prof_aver = prof / i
        print(f'Средняя прибыль - {prof_aver:.2f} руб.')
    else:
        print(f'Прибыль отсутсвует. Организаци убыточны')
    pr = {'Средняя прибыль': round(prof_aver)}
    profit.update(pr)
    print(f'Прибыль организаций, руб.: {profit}')

with open('doc_5_7_1.txt.json', 'w') as write_js:
